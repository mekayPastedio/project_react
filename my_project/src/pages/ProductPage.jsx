...
function ProductPage() {
    ...
    return (
        <div className="bg-white fade-in-up">
            <h1 className="text-2xl mb-6 pl-10 pt-4 font-bold text-[#243642]"> Product Page</h1>
            <div className="grid grid-cols-4 gap-4 mx-10 pb-4 fade-in-up">
                {products.map((product) => {
                    return (
                        <div key={product.id} className="bg-[#16423C] bg-opacity-60 rounded-lg shadow-2xl">
                            <img src={product.images[0]} className="rounded-t-lg h-[280px] w-full" alt={product.title} />

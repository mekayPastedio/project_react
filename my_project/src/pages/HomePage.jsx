...
import plant1 from '../pl1.png';  // Ensure the correct image path
import plant2 from '../pl2.png';  // Same as above
...
function HomePage() {
    return (
        <div className='px-10'>
            <div className="container text-left flex flex-col md:flex-row items-center pt-5 pb-10">
